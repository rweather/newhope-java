...
/**
 * Test harness for NewHopeTor.
 * 
 * This class applies tests to the NewHopeTor class to verify the
 * implementation.  It is not needed in applications that use NewHopeTor.
 */
public class NewHopeTorTest extends NewHopeTor {

	public NewHopeTorTest()
	{
	}
	...
	private static void test_keys()
	{
		...
		NewHope alice = new NewHopeTor();
		NewHope bob = new NewHopeTor();
	...
	private static void test_vectors()
	{
		...
		NewHope alice = new NewHopeTorTest();
		NewHope bob = new NewHopeTorTest();
